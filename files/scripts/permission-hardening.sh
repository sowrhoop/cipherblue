...
# Restricts access to sensitive automation scripts to root only (chmod 700).
# This prevents standard users from reading the rebase or provenance logic.
# ==============================================================================
